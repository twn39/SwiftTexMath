...
/// Internal data tables for TeX control sequences and symbol mapping.
enum AtomFactoryTables {
    ...
    static func buildBuiltinSymbols() -> [String: MathAtom] {
        ...
        put("varinjlim", .largeOperator("lim", limits: true))
        ...
        // Blackboard-bold letter shortcuts
